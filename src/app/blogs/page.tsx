...
export default function Pages() {
    ...
    return (
        <div className="bg-[#1c1d20] flex flex-col items-center h-full overflow-y-hidden overflow-x-hidden">
            <Header />
            ...
            <div className="flex flex-col bg-white h-full w-full items-center">
                <div className="container mt-6 px-10 2xl:px-40 flex flex-col md:flex-row w-full h-full items-start">
                    <button data-string="mazy" onClick={()=>router.push("https://scratch.mit.edu/projects/892089890")} onMouseLeave={(event)=>unhoverProject(event)} onMouseEnter={(event)=>hoverProject(event)} className="flex-1 group">
                        <div  className="grad cardo-bold h-10 text-center text-xl w-full border-b-2 border-[#1c1d20] text-[#1c1d20] group-hover:text-[#2aa084]">Mazy Lost in the Maze</div>
                    ...
                    <button data-string="dobby" onClick={()=>router.push("https://github.com/archiash/eq-manager")} onMouseLeave={(event)=>unhoverProject(event)} onMouseEnter={(event)=>hoverProject(event)} className="flex-1 group">
                        <div  className="grad cardo-bold h-10 text-center text-xl w-full border-b-2 border-[#1c1d20] text-[#1c1d20] group-hover:text-[#2aa084]">Dobby "Reparo" Equation Manager</div>
